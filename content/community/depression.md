...
Our channel operators are well equipped to deal with most channel issues. To ping an operator, simply message "?ops" in the channel. Please do not attempt to mediate between users and the channel rules during this time.
